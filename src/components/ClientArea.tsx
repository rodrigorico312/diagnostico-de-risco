                ...
                {showCancelar && (
                  <div style={{ marginTop: '.8rem', background: '#FEF2F2', borderRadius: '12px', padding: '1.2rem', textAlign: 'center' }}>
                    ...
                    <div style={{ display: 'flex', gap: '.5rem', justifyContent: 'center' }}>
                      ...
                      <a href="https://wa.me/5593991201036?text=Olá, gostaria de cancelar minha assinatura VIVE FIT BOX" target="_blank" rel="noopener" style={{ ...actionBtnStyle, flex: 1, margin: 0, fontSize: '.8rem', background: '#DC2626', textDecoration: 'none' }}>confirmar cancelamento</a>
                    </div>
                  </div>
                )}
              </div>
