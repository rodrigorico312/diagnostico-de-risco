        ...
        {tab === 'plano' && (
          <div>
            ...
            <div style={{ textAlign: 'center', marginTop: '2rem' }}>
              ...
              <a href="https://wa.me/5593991129194" target="_blank" rel="noopener" style={{ fontSize: '.85rem', color: 'var(--turquesa)', textDecoration: 'none', fontWeight: 600 }}>(93) 99112-9194</a>
            </div>
          </div>
        )}
      </div>
